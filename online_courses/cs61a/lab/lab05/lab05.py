...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    lats = get_lat(city_a)-get_lat(city_b)
    lons = get_lon(city_a)-get_lon(city_b)
    return sqrt(lats**2 + lons**2)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    lats1 = get_lat(city_a) - lat
    lons1 = get_lon(city_a) - lon
    lats2 = get_lat(city_b) - lat
    lons2 = get_lon(city_b) - lon
    if lats1**2 + lons1**2 < lons2**2 + lats2**2:
