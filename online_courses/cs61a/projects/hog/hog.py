...
def boar_brawl(player_score, opponent_score):
    ...
    return max(1, 3 * abs(tens_digit(opponent_score) - one_digit(player_score)))
...
def always_roll(n):
    ...
    def return_n(player_score, opponent_score):
        return n
...
def make_averaged(original_function, samples_count=1000):
    ...
    def make_a_sum(*args):
        ...
        for i in range(samples_count):
            summation += original_function(*args)
        return summation / samples_count
    return make_a_sum
    # END PROBLEM 8
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score == 99:
        return 1
    if sus_points(boar_brawl(score, opponent_score) + score) - score >= 11:
        return 0
    if score == 98:
        return 1
    if score >= opponent_score:
